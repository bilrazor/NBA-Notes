...
public class JsonObjectRequestWithAuthHeader2 extends JsonObjectRequest {
    ...
    public JsonObjectRequestWithAuthHeader2(int method, String url, @Nullable JSONObject jsonRequest, Response.Listener<JSONObject> listener, @Nullable Response.ErrorListener errorListener, Context context) {
