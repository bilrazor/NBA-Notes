...
public class JsonArrayRequestWithAuthHeader2 extends JsonArrayRequest {

    private Context context;

    public JsonArrayRequestWithAuthHeader2(int method, String url, JSONArray jsonRequest,
